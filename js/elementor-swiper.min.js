"use strict";
class exticeSwiperBase extends elementorModules.frontend.handlers.Base {
    getDefaultSettings() {
        return {
            selectors: {
    ...
    getSwiperSettings() {
        ...
        var d = "arrows" === s.navigation || "both" === s.navigation,
            c = "dots" === s.navigation || "both" === s.navigation || "custom" === s.navigation;
        return d && (a.navigation = {
            ...
            clickable: !0
        }), void 0 !== s.enable_scrollbar && "yes" === s.enable_scrollbar && (a.scrollbar = {
    ...
    hasNesting() {
        return ["extice-nested-slide"].includes(this.getWidgetType())
    }
